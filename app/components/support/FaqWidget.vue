    ...
    <transition name="chat-slide">
      ...
      >
        ...
        <div class="flex items-center gap-3 bg-indigo-600 px-5 py-4 text-white">
          ...
          <button @click="clearMessages" class="rounded-lg p-1.5! hover:bg-white/20 transition-colors" :title="t('support.widget.clearChat')">
        ...
        <!-- Messages -->
        <div ref="messagesContainer" class="flex-1 overflow-y-auto px-4 py-3 space-y-3" style="min-height: 280px; max-height: 350px;">
          <!-- Welcome message -->
          <div v-if="messages.length === 0" class="flex flex-col items-center justify-center py-8 text-center">
            <div class="mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-indigo-50 dark:bg-indigo-900/30">
            ...
            <h4 class="mb-1 text-sm font-semibold text-gray-900 dark:text-white">{{ t('support.widget.welcomeTitle') }}</h4>
