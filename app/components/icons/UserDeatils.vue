<template>
    <svg width="800px" height="800px" viewBox="0 0 24 24" fill="inherit" xmlns="http://www.w3.org/2000/svg">
        <circle cx="9" cy="9" r="2" stroke="inehrit" stroke-width="1.5" />
        <path
        ...
        <path
            ...
            stroke="inehrit" stroke-width="1.5" stroke-linecap="round" />
        <path d="M19 12H15" stroke="inehrit" stroke-width="1.5" stroke-linecap="round" />
        <path d="M19 9H14" stroke="inehrit" stroke-width="1.5" stroke-linecap="round" />
        <path d="M19 15H16" stroke="inehrit" stroke-width="1.5" stroke-linecap="round" />
    </svg>
</template>
